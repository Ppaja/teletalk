...
var firebaseConfig = {
  ...
  // const dmName =  currentUser + chatPartner;
  ...
  async function loadData() {
    ...
    try {
      ...
      dmName = snapshot.val();
      console.log('Wert des Schlüssels:', dmName);
      initializePage();
    } catch (error) {
      console.error('Fehler beim Abrufen des Werts:', error);
    }
  }
  ...
  function initializePage() {
      ...
      if (translation === "") {
        ...
        var chatCountRef = database.ref(`AllChats/${dmName}/Count/ChatCount`);
        chatCountRef.transaction(
          ...
          function (error, committed, snapshot) {
            if (error) {
              ...
              var chatRef = database.ref(`AllChats/${dmName}/Chat/` + currentCount);
